               ...
               if ($check_evento_c==1){
	               ...
	               for ($i=0;$i<$len;$i++){
	               	...
	               	echo '<div class="col-lg-4"><h2><i class="fa fa-chevron-circle-down"></i> Evento in corso </h2></div>';
	   					...
	   					echo '<button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#chiudi'.$eventi_attivi_c[$i].'"><i class="fas fa-times"></i> Chiudi evento</button>';
	   					echo '</div></div>';
	   					echo '<div class="row">';
	   					echo '<div class="col-lg-6"><h3>Tipologia: '. $tipo_eventi_attivi_c[$i][1].'</h3>';
