...
//values
$query=$query.") VALUES (".$id.", ' L'incarico ".$id." è stato preso in carico da seguente unità operativa: ".$uo." - <a class=\"btn btn-info\" href=\"dettagli_incarico.php?id=".$id."\"> Visualizza dettagli </a>'";
