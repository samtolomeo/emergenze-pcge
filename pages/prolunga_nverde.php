...
$query="SELECT * FROM eventi.t_attivazione_nverde where id_evento=".$id_evento." AND data_ora_inizio=".$time.";";
//echo $query;
//exit;
...
while($r = pg_fetch_assoc($result)) {
	...
	echo " <h4>Attualmente attivazione prevista dalle ".$ora_start." di ".$data_start." alle ore <b>" .$ora_end ." di ".$data_end. " </b></h4>";
}
?>
<h3>Prolunga fino a:</h3>
<form action="eventi/prolunga_nverde2.php?e=<?php echo $id_evento?>&t=<?php echo $time?>" method="POST">
<div class="form-group">
		<label for="data_fine" >Nuova data fine attivazione numero verde (AAAA-MM-GG) </label>                 
  ...
  <button  id="conferma" type="submit" class="btn btn-success">Aggiorna orari numero verde</button>
