...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6">
				<?php
					$query= "SELECT *, st_x(st_transform(geom,4326)) as lon , st_y(st_transform(geom,4326)) as lat FROM segnalazioni.v_incarichi_interni WHERE id=".$id." ORDER BY data_ora_stato DESC LIMIT 1;";
					//echo $query
              ...
              <div class="form-row">
                  ...
                  <option name="mm_start" value="00" > 00 </option>
					...
					$query= "SELECT * FROM segnalazioni.v_incarichi_interni WHERE id=".$id." and id_stato_incarico =".$stato_attuale."  ORDER BY id_segnalazione;";
