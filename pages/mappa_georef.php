...
var mymap = L.map('mapid', {scrollWheelZoom:false}).setView([44.411156, 8.932661], 13);
	...
	var basemap2= L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
		maxZoom: 18,
...
var ourCustomControl = L.Control.extend({
  ...
  onAdd: function (mymap) {
    ...
    container.onclick = function(){
      alert('Prima di tutto occorre selezionare il metodo con cui georeferenziare la segnalazione. \
      \nQualora si scelga l\'opzione "tramite mappa" è possibile cliccare su un punto della mappa per catturarne automaticamente le coordinate\
      \nNB Per effettuare una ricerca usare il tasto con la lente e digitare il topononimo che si intende cercare.')
...
var baseMaps = {/*'OSM': basemap0, 'OSM B&W': basemap1,*/ 'Humanitarian OpensStreetMap': basemap2, 'Realvista e-geos': realvista/*, 'OSM-Mapbox': basemap3*/};
