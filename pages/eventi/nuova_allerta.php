...
$query="INSERT INTO eventi.join_tipo_allerta (id_evento,id_tipo_allerta,data_ora_inizio_allerta,data_ora_fine_allerta) VALUES(".$id.",".$_POST["tipo"].",'".$data_inizio."','".$data_fine."');"; 
echo $query;
//exit;
