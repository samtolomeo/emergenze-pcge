    ...
    if os.path.exists(jsonFile): #check if the file esists
        ...
        for i in json_feat:
            ...
            if check==1:
                ...
                query2="SELECT id_station FROM geodb.lettura_idrometri WHERE id_station ilike '{}' and data_ora ='{}'".format(stazname,data_arpa)
                #print(query2)
                cur2.execute(query2)
                y=cur2.fetchall()
                #print(x)
                ...
                if d=='Idro':
                    if check_u==1:
                        query3= "UPDATE geodb.lettura_idrometri SET lettura={} WHERE id_station='{}' AND \"data_ora\"='{}';".format(valore,stazname,data_utc)
                    else:
                        query3= "INSERT INTO geodb.lettura_idrometri(id_station, data_ora, lettura) VALUES ('{}', '{}', {});".format(stazname,data_utc,valore)
                # elif d=='Press':
