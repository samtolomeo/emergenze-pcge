...
$query="UPDATE eventi.t_eventi SET fine_sospensione=now() where id=$id;";
//echo $query;
//exit;
...
$messaggio="\xF0\x9F\x86\x99 E' stata rimossa la sospensione prevista per l'evento di tipo ".$descrizione_tipo." (id=".$id.").";
$messaggio= $messaggio ." (ricevi questo messaggio in quanto operatore di Protezione Civile)";
$messaggio= $messaggio ." \xF0\x9F\x86\x99";
