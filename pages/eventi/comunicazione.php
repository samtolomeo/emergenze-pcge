...
$query= "INSERT INTO report.t_comunicazione(id_evento, testo";
if (isset($allegato)){
...
$query_log= "INSERT INTO varie.t_log (schema,operatore, operazione) VALUES ('evento','".$operatore ."', 'Inviata comunicazione generica sull'evento ".$id.")');";
echo $query_log."<br>";
