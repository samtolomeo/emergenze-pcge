...
$query= "UPDATE segnalazioni.t_provvedimenti_cautelari SET time_preview='".$time_preview."' 
WHERE id=".$id.";";
echo $query."<br>";
//exit;
...
//values
if ($parziale=='t'){
	$query=$query.") VALUES (".$id_lavorazione.", ' Provvedimento cautelare".$id." preso in carico (parzialmente) dalla seguente squadra.: ".$uo." - <a class=\"btn btn-info\" href=\"dettagli_provvedimento_cautelare.php?id=".$id."\"> Visualizza dettagli </a>'";
} else {
	$query=$query.") VALUES (".$id_lavorazione.", ' Provvedimento cautelare ".$id." preso in carico dalla seguente squadra.: ".$uo." - <a class=\"btn btn-info\" href=\"dettagli_provvedimento_cautelare.php?id=".$id."\"> Visualizza dettagli </a>'";
}
$query=$query.");";
