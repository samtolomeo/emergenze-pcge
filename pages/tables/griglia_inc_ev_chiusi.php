...
if(!$conn) {
	...
	//$idcivico=$_GET["id"];
	$query="SELECT id, id_evento,id_profilo, data_ora_invio, id_stato_incarico, descrizione_stato, 
	descrizione, descrizione_uo, note_ente, id_segnalazione, time_stop 
	From segnalazioni.v_incarichi_eventi_chiusi_last_update where id > 1 ".$filter." 
	UNION
	SELECT id, id_evento, id_profilo, data_ora_invio, id_stato_incarico, descrizione_stato, 
	descrizione, descrizione_uo, note_ente, id_segnalazione, time_stop 
