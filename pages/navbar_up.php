        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Componente da filtrare per tipologia di utente</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                ...
                <!-- /.dropdown -->
				 ...
				 <!--li class="nav-item active">
					<a class="nav-link" href="#panel-notifiche"><i class="fas fa-bell fa-fw"></i><span class="sr-only">(current)</span></a>
				</li-->
