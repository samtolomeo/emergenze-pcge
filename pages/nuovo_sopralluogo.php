...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <h4><i class="fas fa-pencil-ruler"></i> Descrizione sopralluogo</h4> 
           ...
           $len=count($eventi_attivi);	               
            ...
            <button  type="submit" class="btn btn-primary">Assegna sopralluogo</button>
            </div>
            <!-- /.row -->
