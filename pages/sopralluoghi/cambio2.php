...
if ($id_lavorazione!=''){
	...
	//values
	$query=$query.") VALUES (".$id_lavorazione.", 'La squadra ".$squadra_old." sta abbandonando il sopralluogo ".$id_sopralluogo." (sostituzione in corso) </i><br>- <a class=\"btn btn-info\" href=\"dettagli_sopralluogo.php?id=".$id."\"> Visualizza dettagli </a>'";
...
$query_log= "INSERT INTO varie.t_log (schema,operatore, operazione) VALUES ('sopralluoghi','".$operatore ."', 'Cambio squadra per sopralluogo ".$id_sopralluogo." accordato e in corso');";
echo $query_log."<br>";
