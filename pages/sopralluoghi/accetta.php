...
$query= "UPDATE segnalazioni.t_sopralluoghi SET time_preview='".$time_preview."' 
WHERE id=".$id.";";
echo $query."<br>";
//exit;
...
$query= "INSERT INTO segnalazioni.stato_sopralluoghi(id_sopralluogo, id_stato_sopralluogo, parziale";
...
if ($note!=''){
	...
	$query= "INSERT INTO segnalazioni.t_comunicazioni_sopralluoghi(
